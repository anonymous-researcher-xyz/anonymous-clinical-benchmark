...
def train_rslora(
    ...
    logger.info(f"🚀 Starting RSLoRa training for {dataset_name}")
...
def main():
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("../../models/rslora"))
