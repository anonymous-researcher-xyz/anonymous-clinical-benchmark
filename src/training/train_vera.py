"""
VeRA Fine-tuning for Clinical Benchmark PT
Uses the SAME PROMPTS as Zero-Shot inference.
Supports: QA, multiple_choice, Summarization, Classification, NER
See more information: https://huggingface.co/docs/peft/main/en/package_reference/vera
"""
...
from peft import LoraConfig, AdaLoraConfig, get_peft_model, VeraConfig, prepare_model_for_kbit_training
