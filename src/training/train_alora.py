"""
ALoRA Fine-tuning for Clinical Benchmark PT
Uses the SAME PROMPTS as Zero-Shot inference.
Supports: QA, multiple_choice, Summarization, Classification, NER
For more informatcion: https://huggingface.co/docs/peft/main/en/developer_guides/lora#activated-lora-alora
"""
...
def train_alora(
    ...
    logger.info(f"🚀 Starting ALoRA training for {dataset_name}")
    ...
    invocation_string = "<start_of_turn>model\n"
...
def main():
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("../../models/alora"))
